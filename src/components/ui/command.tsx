...
const CommandItem = ({
  ...
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative text-black dark:text-white flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-hidden aria-selected:bg-accent aria-selected:text-accent-foreground data-disabled:pointer-events-none',
      className,
    )}
    {...props}
  />
